                            ...
                            {recentTransactions.map((item) => (
                                ...
                                >
                                    <div className="flex items-start gap-3">
                                        <div
                                            className={`w-8 h-8 rounded-lg flex items-center justify-center shrink-0 mt-0.5 ${item.tipe === 'pemasukan'
                                    ...
                                    <span
                                        className={`text-xs font-bold shrink-0 ml-2 ${item.tipe === 'pemasukan' ? 'text-emerald-600 dark:text-emerald-400' : 'text-red-500'
                                            }`}
                                    >
